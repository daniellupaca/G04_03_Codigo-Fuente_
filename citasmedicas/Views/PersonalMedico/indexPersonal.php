    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <center>
                    <h5 class="card-title fw-semibold mb-4">Informacion del Personal</h5>
                </center>
                <div class="card">
                    <div class="card-body">
                      <form action="../../Controller/PersonalController.php" method="POST">
                          <div class="mb-3">
                            <label for="dni" class="form-label">DNI del Personal:</label>
                            <input type="number" class="form-control" id="dni" name="dni" value="<?php echo $_SESSION['userId']; ?>" readonly>
                          </div>
                          <div class="mb-3">
                          ...
                          <div class="mb-3">
                              <label for="sexo" class="form-label">Sexo del Personal:</label>
                              <input type="text" class="form-control" id="sexo" value="<?php echo $sexo; ?>" disabled>
                          </div>
                          <div class="mb-3">
